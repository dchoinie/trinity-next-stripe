                ...
                <div className="flex">
                    <div className="flex flex-col w-1/2 self-center p-6">
                        ...
                        <ul className="list-disc list-inside ml-12 mb-2 text-gray-800">
                            <li className="italic">the pure preaching of God’s holy Word</li>
                            <li className="italic">the right administration of Christ’s holy Sacraments</li>
                            <li className="italic">the faithful teaching of the Christian faith</li>
                            <li className="italic">the reverent, liturgical worship of the evangelical Lutheran Church</li>
                        </ul>
